...
def main(args):
    ...
    if args.pretrained_path is not None:
        ...
        aux_model.load_state_dict(assistant_state_dict, strict=True)
    ...
    reparameterize_aux_into_target_model(classifier.blocks, aux_model, layer_names=('attn.qkv', 'attn.proj', 'mlp.fc1','mlp.fc2'))    
    print(classifier)
    classifier.cuda()
