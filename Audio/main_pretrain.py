...
def get_args_parser():
    ...
    parser.add_argument("--data_train", type=str, default='/data/audioset/16k/train_cleaned.json', help="training data json")
    parser.add_argument("--data_eval", type=str, default='/data/audioset/16k/eval_cleaned.json', help="validation data json")    
