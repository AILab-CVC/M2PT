...
from util.misc import auto_load_model
...
def get_args_parser():
    ...
    parser.add_argument('--pretrained_path', type=str,help='pretrained weights for aux models')
    return parser
...
def main(args):
    ...
    # auto resume
    auto_load_model(args, model_without_ddp, optimizer, loss_scaler)
